...
| **Policy + TASK-ARITHMETIC merge — ta15_α0.7** (5k seeds, no cap) | **31,617** | **22,181** | 93,129 | **1.6%** | None ← **new best, 5k-confirmed** (α0.4 ties: 31,790/21,591; plateau α∈[0.4,0.7]) |
...
Individual single-game scores have reached **301,050** (ta15_α0.7, 5k eval) — many multiples of the long-standing 40K expert-human ceiling.
